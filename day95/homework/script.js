...
function school() {
    ...
    if (students > 10) {
        ...
        console.log(students) // block scope (global)
...
// N11 ---> scope არის ის თუ სად შეგვიძლია ცვლადს მივწვდეთ, ანუ სად არის იგი ხელმისაწვდომი და გვაქვს 2 სახის scope, ესენია: global და block სკოუპები global არის ისეთი რომელსაც ყველგან მივწვდებით ნებისმიერი ბლოკიდან ანუ ისეთია რომელიც ბლოკის გარეთაა, ხოლო block არის ბლოკში მყოფი ცლვადი რომელსაც მხოლოდ ლოკალურად შეგვიძლია მივწვდეთ ანუ იმ ბლოკში სადაც იგი იმყოფება.